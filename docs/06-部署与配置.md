...
# PostgreSQL (生产环境)
# DATABASE_URL="postgresql://user:password@localhost:5432/data_analysis_agent?schema=public"
...
CREATE DATABASE data_analysis_agent OWNER datauser;
GRANT ALL PRIVILEGES ON DATABASE data_analysis_agent TO datauser;
\q

# 环境变量
DATABASE_URL="postgresql://datauser:your-password@localhost:5432/data_analysis_agent?schema=public"
