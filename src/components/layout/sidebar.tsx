...
import { hasPermission, ModulePermission, UserRole } from "@/lib/permissions";
...
const navItems: Array<{
  ...
  {
    title: "突变高亮标记",
    href: "/mutation-highlight",
    permission: "mutationHighlight",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  {
    title: "序列重编号",
    href: "/sequence-sorting",
    permission: "sequenceSorting",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
...
export function Sidebar() {
  ...
  const userPermissions = (user?.permissions || []) as ModulePermission[];

  // 判断是否可以访问用户管理
  const canAccessUserManagement = hasPermission(
    userRole,
    userPermissions,
    "userManagement",
  );
